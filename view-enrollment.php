...
$sqlfetchenrolledstudent = mysqli_query($conn, "SELECT * FROM enroll WHERE no='".$_GET['id']."'  "  );
                   ...
                   <div class="row">
                    <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="list-group">
                                    <li class="list-group-item">fullname: <span class="float-right badge badge-secondary "><?php echo $fullname ?></span></li>  
